...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `${personaCtx} ${COLOUR_ANALYST_VOICE} ${STYLIST_2026_LENS}
${styleBriefCtx ? styleBriefCtx + '\n' : ''}${styleDirectives}Score each item's VALUE to this wardrobe using a nuanced rubric — NOT just frequency of wear. Be honest: a great stylist tells the truth about what is and isn't working.
${profileLine}
SCORING RUBRIC (0–10):
