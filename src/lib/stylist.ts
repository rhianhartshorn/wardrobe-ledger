...
— BUILD AROUND THE HIGHEST-IMPACT PIECE. Before finalizing, identify the single most editorial, characterful, or occasion-defining piece the wardrobe offers FOR THIS BRIEF — the statement coat, the one real tailoring piece, the print, the sculptural silhouette — and build the look around it. Settling for a strong-but-predictable combination while the wardrobe's boldest coherent option sits unused is the most common way a competent look stops short of a great one. A safe pairing that "works" is a miss if a bolder pairing would also have worked and said more. When the brief is "smart" and there is a genuine tailoring piece (a structured blazer, a sharp coat), that piece is usually the highest-impact move — reach for it rather than a softer two-piece. Under-reaching is as much a failure as over-styling.
